								...
								<div className='modal-content text-center mt-3 sm:mt-0 sm:ml-4 sm:text-left'>
									...
									<div className='modal-text mt-2'>
										<p className='text-gray-500 text-sm'>
											...
											Eius asperiores quam temporibus porro esse numquam
											accusantium odio. Nemo harum voluptas veniam facilis
											magnam a natus! Debitis explicabo ab eaque excepturi!
										</p>
									</div>
								</div>
							</div>
